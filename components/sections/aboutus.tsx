  ...
  return(
    <section id="aboutus" className="container mx-auto px-6 py-16">
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-6">
        ...
        >
            <div className="overflow-hidden text-slate-800 relative text-wrap mx-auto bg-slate-100/40 p-16 before:border-t-2 before:absolute before:top-4 before:left-4 before:block before:border-l-2 before:border-slate-500 before:h-16 before:w-16
